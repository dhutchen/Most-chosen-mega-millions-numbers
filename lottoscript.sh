...
#Print second through fourth most chosen combinations of numbers.
  ...
  shuf -n 1 numbersonly.csv
        ...
        printf "Doing some house cleaning."
        rm numbersonly.csv
        printf "\n"
        printf "All done. Good Luck!"
        printf "\n"
